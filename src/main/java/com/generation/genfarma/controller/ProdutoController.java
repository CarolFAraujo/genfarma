package com.generation.genfarma.controller;
...
import com.generation.genfarma.repository.CategoriaRepository;
import com.generation.genfarma.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	// Consulta pelo maior preço, greaterthan
	...
	// Consulta pelo menor preço, lessthan
	...
	// Consulta pelo nome e fabricante, and
	
	@GetMapping("/nome/{nome}/efabricante/{fabricante}")
	public ResponseEntity<List<Produto>> getNomeAndFabricante(@PathVariable String nome, @PathVariable String fabricante) {
		return ResponseEntity.ok(produtoRepository.findAllByNomeAndFabricante(nome, fabricante));
	
	
}
	
	// Consulta pelo nome ou fabricante, or

	
	@GetMapping("/nome/{nome}/oufabricante/{fabricante}")
	public ResponseEntity<List<Produto>> getNomeOrFabricante(@PathVariable String nome, @PathVariable String fabricante) {
		return ResponseEntity.ok(produtoRepository.findAllByNomeOrFabricante(nome, fabricante));
}
	
	// Consulta dentro de um intervalo de preço, between
